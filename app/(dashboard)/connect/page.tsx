...
function StatusMessage({
  ...
  if (error) {
    const messages: Record<string, string> = {
      ...
      token_exchange_failed: 'Failed to exchange authorization code. This could be due to: expired authorization code, redirect URI mismatch, or invalid code verifier. Check server logs for details.',
